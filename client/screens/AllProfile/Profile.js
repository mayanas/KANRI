 ...
 class Profile extends Component{
  constructor(props){
    ...
    this.state = {
      ...
      who:true, //if true the profile owner else a visitor
      followtext:"Follow",
      color:"#bc9855",
      IsFollowed:false,
      ...
      if(!this.state.phonevalid)
        {
          ...
          this.setState({PhoneNumber:this.state.PhoneNumberUpdated,phonevalid:false,
            phonevalue:"",})
...
<Modal animationType='slide'
   ...
   onRequestClose={()=>{this.setState({PhoneModal:false})
